...
├── vitest.config.ts         # Vitest: node env by default, *.test.ts + *.test.tsx,
│                            #   resolve.tsconfigPaths for @/*
